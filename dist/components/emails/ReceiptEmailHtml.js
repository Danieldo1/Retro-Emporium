...
var ReceiptEmail = function (_a) {
    ...
    var subTotal = products.reduce(function (acc, curr) { return acc + curr.price; }, 0);
    var total = subTotal + (subTotal > 75 ? 0 : 10);
    return (React.createElement(components_1.Html, null,
        React.createElement(components_1.Head, null),
        React.createElement(components_1.Preview, null, "Your Retro Emporium Receipt"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/verify-email.png"), width: '100', height: '100', alt: 'RetroEmporium' })),
                ...
                products.map(function (product) {
                    ...
                    return (React.createElement(components_1.Section, { key: product.id },
                        ...
                        React.createElement(components_1.Column, { style: { paddingLeft: '22px' } },
                            ...
                            React.createElement(components_1.Link, { href: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/success?orderId=").concat(orderId), style: productLink }, "Download Asset")),
                ...
                React.createElement(components_1.Section, null,
                    ...
                    React.createElement(components_1.Column, { style: { paddingLeft: '40px', paddingTop: 20 } },
                        React.createElement(components_1.Text, { style: productTitle }, "Shipping")),
                    React.createElement(components_1.Column, { style: productPriceWrapper, align: 'right' },
                        React.createElement(components_1.Text, { style: productPrice }, (0, utils_1.formatPrice)(subTotal > 75 ? 0 : 10)))),
                ...
                React.createElement(components_1.Text, { style: footerCopyright },
                    "Copyright \u00A9 2023 RetroEmporium Inc. ",
