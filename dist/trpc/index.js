...
var query_1 = require("../lib/validators/query");
var getPayload_1 = require("../getPayload");
var payment_1 = require("./payment");
exports.appRouter = (0, trpc_1.router)({
    auth: auth_1.authRouter,
    payment: payment_1.paymentRouter,
    getAllProducts: trpc_1.publicProcedure.input(zod_1.z.object({
        limit: zod_1.z.number().min(1).max(100),
        cursor: zod_1.z.number().nullish(),
        query: query_1.QueryValidator
    })).query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, sort, limit, queryOpts, payload, parsedQuery, page, _b, products, hasNextPage, nextPage;
