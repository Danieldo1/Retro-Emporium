...
var yourPurchasedProducts = function (_a) {
    var req = _a.req;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProducts, orders, purchasedProducts;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ownProducts = products.map(function (product) { return product.product_files; }).flat();
                    return [4 /*yield*/, req.payload.find({
                            collection: "orders",
                            depth: 2,
                            where: {
                ...
                case 2:
                    orders = (_b.sent()).docs;
                    purchasedProducts = orders.map(function (order) {
                        return order.products.map(function (product) {
                            if (typeof product === 'string')
                                return req.payload.logger.error('Search depth is not sufficient to find purchased file ID');
                            return typeof product.product_files === 'string' ? product.product_files : product.product_files.id;
                        });
                    }).filter(Boolean).flat();
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProducts, true), purchasedProducts, true)
                            }
                        }];
            }
        });
