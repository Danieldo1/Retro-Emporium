        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    allIDs_1 = __spreadArray([], ((products === null || products === void 0 ? void 0 : products.map(function (p) { return typeof p === 'object' ? p.id : p; })) || []), true);
                    createdProductIDs = allIDs_1.filter(function (id, i) { return allIDs_1.indexOf(id) === i; });
...
var isYouOrAdmin = function () { return function (_a) {
    ...
    if (user.role === 'admin')
        return true;
    var userProductsIDs = (user.products || []).reduce(function (acc, p) {
        if (!p)
            return acc;
        if (typeof p === 'string') {
            acc.push(p);
...
exports.Products = {
    ...
    fields: [
        ...
        },
        {
            ...
            label: "Category",
            type: "select",
            options: config_1.PROD_CATEGORIES.map(function (_a) {
