...
export const ReceiptEmail = ({email,date,orderId,products}:ReceiptEmail) => {

    const subTotal = products.reduce((acc, curr) => acc + curr.price, 0);
    const total = subTotal + (subTotal > 75 ? 0 : 10);
    ...
    return (
        ...
        <Html>
    <Head />
    <Preview>Your Retro Emporium Receipt</Preview>
    ...
    <Container style={container}>
        ...
        <Column>
            <Img
            src={`${process.env.NEXT_PUBLIC_SERVER_URL}/verify-email.png`}
            width='100'
            height='100'
            alt='RetroEmporium'
            />
        ...
        return (
            ...
            <Column style={{ paddingLeft: '22px' }}>
                ...
                <Link
                href={`${process.env.NEXT_PUBLIC_SERVER_URL}/success?orderId=${orderId}`}
                style={productLink}>
                Download Asset
                </Link>
            </Column>
        ...
        <Column style={{ paddingLeft: '40px', paddingTop: 20 }}>
            <Text style={productTitle}>Shipping</Text>
        </Column>

        <Column style={productPriceWrapper} align='right'>
            <Text style={productPrice}>{formatPrice(subTotal > 75 ? 0 : 10)}</Text>
        </Column>
        </Section>
        ...
        Copyright © 2023 RetroEmporium Inc. <br />{' '}
